...
import { CloudStorageConfig, Essay, EssayScore } from '../types';
...
export const storage = {
  ...
  generateShareLink: async (fileId: string, options: Record<string, unknown>) => {
...
export const essays = {
  submit: async (essay: Omit<Essay, 'id' | 'submittedAt'>) => {
  ...
  grade: async (essayId: string, score: EssayScore) => {
